  ...
  return <AppShell><main>
    <section className="relative overflow-hidden bg-sidebar px-5 pb-24 pt-16 text-sidebar-foreground lg:px-8 lg:pb-32 lg:pt-24">
      ...
      <div className="relative mx-auto grid max-w-[1240px] items-end gap-14 lg:grid-cols-[1.02fr_.98fr]">
        <div className="rise-in"><h1 className="mt-7 max-w-2xl font-display text-6xl font-semibold leading-snug tracking-[-.055em]">Adaptive<br /><span className="text-secondary">Maritime Dispatch.</span></h1><p className="mt-8 max-w-md text-base leading-7 text-sidebar-foreground/70">A ride, a rescue, or the supplies an island is waiting for—called by people who know every shoal and dock.</p><div className="mt-9 grid max-w-2xl gap-3 sm:grid-cols-3"><Link href="/book" className="focus-ring inline-flex items-center justify-between gap-3 rounded-[22px] bg-secondary px-5 py-4 text-sm font-extrabold text-sidebar transition-transform hover:-translate-y-1" data-testid="link-hero-book"><span><span className="block text-[10px] uppercase tracking-[.16em] opacity-60">Voyage mode</span><span className="mt-1 block">Plan a crossing</span></span><ArrowRight size={18} /></Link><Link href="/supplies" className="focus-ring inline-flex items-center justify-between gap-3 rounded-[22px] bg-amber-600 px-5 py-4 text-sm font-extrabold text-white transition-transform hover:-translate-y-1" data-testid="link-hero-supplies"><span><span className="block text-[10px] uppercase tracking-[.16em] text-white/70">Supply mode</span><span className="mt-1 block">Send essentials</span></span><Sailboat size={18} /></Link><Link href="/emergency" className="focus-ring inline-flex items-center justify-between gap-3 rounded-[22px] border border-destructive/50 bg-destructive px-5 py-4 text-sm font-extrabold text-white transition-transform hover:-translate-y-1" data-testid="link-hero-emergency"><span><span className="block text-[10px] uppercase tracking-[.16em] text-white/70">Response mode</span><span className="mt-1 block">Need help now</span></span><LifeBuoy size={18} /></Link></div><Link href="/fleet" className="focus-ring mt-4 inline-flex items-center gap-2 text-sm font-bold text-sidebar-foreground/80 hover:text-sidebar-foreground" data-testid="link-hero-fleet">Meet the live fleet <ArrowRight size={15} /></Link></div>
